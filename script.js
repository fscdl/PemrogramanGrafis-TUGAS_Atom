...
// Fungsi resizeCanvas tidak diperlukan jika tidak ingin mengubah ukuran kanvas secara dinamis
/*
...
function drawAtom(rotationAngle) {
    ...
    // Gambar inti atom (menggunakan ukuran yang sama dengan orbit elektron)
    drawEllipse(centerX, centerY, 0.1, 0.3, 70, 0);

    // Gambar orbit elektron dengan orientasi berbeda
    drawEllipse(centerX, centerY, 0.1, 0.3, 70, 0); // Kiri ke kanan
    drawEllipse(centerX, centerY, 0.1, 0.3, 70, Math.PI / 2); // Atas ke bawah
    drawEllipse(centerX, centerY, 0.1, 0.3, 70, Math.PI / 4); // Kanan atas ke kiri bawah
